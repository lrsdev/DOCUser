Location.create(id: 1, name: 'St Claire', location_type: 0, blurb: 'Nice beach', 
                dog_guidelines: 'No dogs North of esplanade', dog_status: 0,
...
Location.create(id: 2, name: 'St Kilda', location_type: 0, blurb: 'Okay beach',
                dog_guidelines: 'Dogs okay in all areas of beach', dog_status: 0,
...
Report.create(id: 1, location_id: 1, user_id: 1, geolocation: 'POINT(-122 47)', blurb: "Spotted seal near beach entrance",
             image: open('http://d1k2jfc4wnfimc.cloudfront.net/assets/matakohe/images/contentfill.jpg', "r"),
             image_file_name: 'penguin.jpg')

Report.create(id: 2, location_id: 2, user_id: 1, geolocation: 'POINT(-122 47)', blurb: "Spotted Penguin near lookout",
